  ...
  hero: {
    ...
    subtitle: {
      tr: [
        ...
        { text: ' yüksek onur derecesi ve ' },
        { text: 'Koç Üniversitesi Klinik Psikoloji', bold: true },
        { text: ' yüksek lisans. ' },
        { text: 'Bilişsel Davranışçı Terapi', bold: true },
        { text: ', ' },
        { text: 'EMDR', bold: true },
        { text: ' ve ' },
        { text: 'Sorun Çözme Terapisi', bold: true },
        { text: ' ile ' },
        { text: 'yetişkin, çift, çocuk ve ergenlere', bold: true },
        { text: ' destek.' },
      ],
      en: [
        { text: 'Boğaziçi University Psychology', bold: true },
        { text: ' (high honors) and ' },
        { text: 'Koç University Clinical Psychology', bold: true },
        { text: ' (MA). Working with ' },
        { text: 'adults, couples, children and adolescents', bold: true },
        { text: ' using ' },
        { text: 'CBT', bold: true },
        { text: ', ' },
        { text: 'EMDR', bold: true },
        { text: ' and ' },
        { text: 'Problem-Solving Therapy', bold: true },
        { text: '.' },
      ],
    },
    ctaPrimaryLabel: {
